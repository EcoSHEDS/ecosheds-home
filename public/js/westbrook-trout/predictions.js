...
(new Runtime()).module(define, name => {
  ...
  if (name === 'swatchesSpp') return Inspector.into('#observablehq-101e6c76 .observablehq-swatchesSpp')()
  ...
  if (name === 'usgsText') return Inspector.into('#observablehq-101e6c76 .observablehq-usgsText')()
